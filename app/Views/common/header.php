                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div id="dropdown-menu" class="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                        <div class="py-1" role="none">
                                            ...
                                            <!-- <?//php foreach ($dispositivo as $dispo): ?>
                                                <a href="<?//= site_url('mostrar_datos'); ?>" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="menu-item-<?//= htmlspecialchars($dispo['id_dispositivo']); ?>">
                                                    <?//php echo htmlspecialchars($dispo['nombre']); ?>
                                                </a>
                                            <?//php endforeach; ?> -->
                                            <?php $dispositivos = $session->get('dispositivo') ?? [];
